...
class Renderer(object):
    ...
    def render(self):
        ...
        camPitch = glm.rotate(i, glm.radians( self.pitchAngle % 360 ), glm.vec3(1,0,0))
        camYaw   = glm.rotate(i, glm.radians( self.yawAngle % 360 ), glm.vec3(0,1,0))
        camRoll  = glm.rotate(i, glm.radians( self.rollAngle % 360 ), glm.vec3(0,0,1))
